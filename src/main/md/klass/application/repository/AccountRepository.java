...
public class AccountRepository extends AbstractRepository<Account, String, String>
    implements RowMapper<Account> {

  public AccountRepository() {
    this.tableName = "Account";
    this.SQLInsert = " insert into Account(username, password, userId) values(?,?,?); ";
  }

  @Override
  public void insertOperation(PreparedStatement preparedStatement, Account account)
      throws SQLException {
  ...
  @Override
  protected void updateOperation(PreparedStatement preparedStatement, Account model)
      throws SQLException {
    // is not needed yet
  }
